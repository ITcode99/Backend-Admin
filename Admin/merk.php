  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-2">
        <h3><i class="fab fa-spotify mr-2"></i> Daftar Merk Mobil | <b> Apple Car </b> <i class="fab fa-apple"></i></h3><hr>
      <div class="container"> 
<!-- ini awal curd form -->
        <div class="card mt-8">
          <div class="card-header bg-primary text-white">
            <i class="fab fa-spotify mr-2"></i>Form Merk Mobil
            </div>
              <div class="card-body">
                <form method="post" action="">
                  ...
                  <div class="form group">
                    <label>Asal</label>
                    <select class="form-control" name="tasal">
...
<div class="card mt-8">
    ...
    <i class="fab fa-spotify mr-2"></i>Daftar Merk Mobil
     </div>
     <div class="card-body">
       ...
       <table class="table table-bordered table-striped">
           ...
           <tr>
               ...
               <td><?=$data['asal']?></td>
               <td>
                   <a href="merk.php?hal=edit&id=<?=$data['id_mhs']?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
                   <a href="merk.php?hal=hapus&id=<?=$data['id_mhs']?>" onclick="return confirm('Apakah Yakin Ingin Menghapus Data Ini?')" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
               </td>
           </tr>
