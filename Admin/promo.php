  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-2">
        <h3><i class="fas fa-tags mr-2"></i> Promo Perusahaan | <b> Apple Car </b><i class="fab fa-apple"></i></h3><hr>
          ...
          <div class="card bg-warning ml-5" style="width: 19rem;">
            <div class="card-body">
              <div class="card-body-icon">
                ...
                <h5 class="card-title">Promo Awal Tahun</h5><hr class="bg-warning">
                <div class="display-4">
                  Diskon 20%
                  Cashback 5jt
                  Produk Nissan
          ...
          <div class="card bg-info ml-5" style="width: 19rem;">
            <div class="card-body">
              <div class="card-body-icon">
                ...
                <h5 class="card-title">Promo Akhir Tahun</h5><hr class="bg-warning">
                <div class="display-4">
                  Cashback 2jt
                  Produk BMW
                </div>
            ...
            <div class="card-body">
              <div class="card-body-icon">
                ...
                <h5 class="card-title">Promo Valentin</h5><hr class="bg-warning">
                <div class="display-4">
                  Diskon 30%
                  Cashback 4jt
                  Semua Produk
          ...
          <div class="card bg-info ml-5" style="width: 19rem;">
            <div class="card-body">
              <div class="card-body-icon">
                ...
                <h5 class="card-title">Promo Ulang Tahun</h5><hr class="bg-warning">
                <div class="display-4">
                  Diskon 50%
                  Cashback 50%
                  Semua Produk
          ...
          <div class="card bg-success ml-5" style="width: 19rem;">
            <div class="card-body">
              <div class="card-body-icon">
                ...
                <h5 class="card-title">Promo Musim Panas</h5><hr class="bg-warning">
                <div class="display-4">
                 Cashback 10jt
                 Produk Lamborghini 
                </div>
            ...
            <div class="card-body">
              <div class="card-body-icon">
                ...
                <h5 class="card-title">Promo Liburan</h5><hr class="bg-warning">
                <div class="display-4">
                  Cashback 5jt
                  Semua Produk
                </div>
          ...
          <div class="card bg-warning ml-5" style="width: 19rem;">
            <div class="card-body">
              <div class="card-body-icon">
                ...
                <h5 class="card-title">Promo Hari Natal</h5><hr class="bg-warning">
                <div class="display-4">
                  Cashback 12jt
                  Disko 50%
                  Produk Ferrari & Lamborghini
                </div>
                <a href=""><p class="card-text text-white">Lihat Detail <i class="fas fa-angle-double-right ml-2"></i></p></a>
              </div>
            </div>
          ...
          <div class="card bg-danger ml-5" style="width: 19rem;">
            <div class="card-body">
              <div class="card-body-icon">
                ...
                <h5 class="card-title">Promo Hari Kemerdekaan</h5><hr class="bg-warning">
                <div class="display-4">
                  Special Cashback 20jt
                  Semua Produk
                </div>
                <a href=""><p class="card-text text-white">Lihat Detail <i class="fas fa-angle-double-right ml-2"></i></p></a>
              </div>
            ...
            <div class="card-body">
              <div class="card-body-icon">
                ...
                <h5 class="card-title">Promo Produk Baru</h5><hr class="bg-warning">
                <div class="display-4">
                  Diskon 20%
                  Produk Baru
                </div>
