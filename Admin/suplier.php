<?php
    ...
    if(isset($_POST['bsimpan']))
    {
        ...
        else
        {
            ...
            $simpan = mysqli_query($koneksi, "INSERT INTO tmhs (nama, asal, produk)
                                              VALUES ('$_POST[tnama]',
                                                      '$_POST[tasal]',
                                                      '$_POST[tproduk]')
                                        ");
  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-2">
        <h3><i class="fas fa-globe-asia mr-2"></i></i> Daftar Suplier Mobil | <b> Apple Car </b> <i class="fab fa-apple"></i></h3><hr>
      <div class="container"> 
<!-- ini awal curd form -->
        <div class="card mt-8">
          <div class="card-header bg-primary text-white">
            <i class="fas fa-globe-asia mr-2"></i>Form Suplier Mobil
            </div>
              <div class="card-body">
                <form method="post" action="">
                  <div class="form group">
                     <label>Nama Perusahaan</label>
                     <input type="text" name="tnama" value="<?=@$vnama?>" class="form-control" placeholder="Input Nama Perusahaan Disini!" required>
                  </div>
                  <div class="form group">
                    <label>Asal Perusahaan</label>
                    <input type="text" name="tasal" value="<?=@$vasal?>" class="form-control" placeholder="Input Asal Perusahaan Disini!" required>
                  </div>
                  <div class="form group">
                    <label>Produk Perusahaan</label>
                    <input type="text" name="tproduk" value="<?=@$vproduk?>" class="form-control" placeholder="Input Produk Perusahaan Disini!" required>
                  </div>
...
<div class="card mt-8">
    ...
    <i class="fas fa-globe-asia mr-2"></i>Daftar Suplier Mobil
     </div>
     <div class="card-body">
       ...
       <table class="table table-bordered table-striped">
           ...
           <tr>
               ...
               <td><?=$data['produk']?></td>
               <td>
                   <a href="suplier.php?hal=edit&id=<?=$data['id_mhs']?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a>
                   <a href="suplier.php?hal=hapus&id=<?=$data['id_mhs']?>" onclick="return confirm('Apakah Yakin Ingin Menghapus Data Ini?')" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
               </td>
           </tr>
